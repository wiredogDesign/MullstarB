!(function () {
    ...
    e(r, {
        ...
        $: function (t, e) {
            return t instanceof Node || t instanceof Window
                ...
                ? Array.prototype.slice.call("string" == typeof t ? (e || document).querySelectorAll(t) : t || [])
                : [];
        },
        defined: function () {
        ...
        Class: function (t) {
            var e,
                n = ["constructor", "extends", "abstract", "static"].concat(Object.keys(r.classProps)),
            ...
            2 == arguments.length
                ...
                : ((e = function () {
                  ...
                  (e.prototype = r.extend(Object.create(e["super"] ? e["super"].prototype : Object), { constructor: e })),
            ...
            lazy: t(function (t, e, n) {
                return (
                    Object.defineProperty(t, e, {
                        get: function () {
                            var t = n.call(this);
                            return Object.defineProperty(this, e, { value: t, configurable: !0, enumerable: !0, writable: !0 }), t;
                        },
                        set: function (t) {
        ...
        fetch: function (t, n) {
            ...
            var i = e({ url: new URL(t, location), data: "", method: "GET", headers: {}, xhr: new XMLHttpRequest() }, n);
            ...
            for (var o in n)
                if ("upload" === o) i.xhr.upload && "object" == typeof n[o] && r.extend(i.xhr.upload, n[o]);
                else if (o in i.xhr)
                    try {
                        i.xhr[o] = n[o];
                    } catch (s) {
            ...
            var u = new Promise(function (t, e) {
                (i.xhr.onload = function () {
                    document.body.removeAttribute("data-loading"),
                        0 === i.xhr.status || (i.xhr.status >= 200 && i.xhr.status < 300) || 304 === i.xhr.status
                            ? t(i.xhr)
                            : e(
    ...
    (r.Element = function (t) {
        ...
        (r.Element.prototype = {
                ...
                return new Promise(
                    function (n, i) {
                        if ("transition" in this.style && 0 !== e) {
                            ...
                            r.style(this, { transitionDuration: (e || 400) + "ms", transitionProperty: Object.keys(t).join(", ") }),
            ...
            bind: t(function (t, e) {
                if (arguments.length > 1 && ("function" === r.type(e) || e.handleEvent)) {
                    var n = e;
                    (e = "object" === r.type(arguments[2]) ? arguments[2] : { capture: !!arguments[2] }), (e.callback = n);
                }
            ...
            unbind: t(function (t, e) {
                ...
                "boolean" == r.type(e) && (e = { capture: e }), (e = e || {}), (e.callback = e.callback || n);
                var i = r.listeners.get(this);
                (t || "")
                    .trim()
                    .split(/\s+/)
                                ...
                                if (!t || o === t)
                                    for (var s, a = 0; (s = i[o][a]); a++)
                                        (n && n !== s.className) ||
                                            ...
                                            (!!e.capture != !!s.capture && (t || e.callback || void 0 !== e.capture)) ||
                                            (i[o].splice(a, 1), r.original.removeEventListener.call(this, o, s.callback, s.capture), a--);
        ...
        (r.setProps = {
            ...
            events: function (t) {
                if (1 != arguments.length || !t || !t.addEventListener) return r.bind.apply(this, [this].concat(r.$(arguments)));
                var e = this;
                if (r.listeners) {
            ...
            contents: function (t) {
                (t || 0 === t) &&
                    (Array.isArray(t) ? t : [t]).forEach(function (t) {
                        var e = r.type(t);
                        /^(string|number)$/.test(e) ? (t = document.createTextNode(t + "")) : "object" === e && (t = r.create(t)),
            ...
            for (
                var e,
                                ...
                                : (p++,
                                  ...
                                  58 === u(p)
                                      ? (p++,
                                        ...
                                        { type: "ConditionalExpression", test: t, consequent: e, alternate: r })
                                      : void k("Expected :", p))
                        );
                    },
                    l = function () {
                    ...
                    a = function () {
                        ...
                        if (((i = h()), !(r = l()))) return i;
                        for (
                            o = { value: r, prec: L(r) }, (a = h()) || k("Expected expression after " + r, p), n = [i, o, a];
                            (r = l()) && 0 !== (t = L(r));

                        ) {
                            for (o = { value: r, prec: t }, s = r; 2 < n.length && t <= n[n.length - 2].prec; )
                                (a = n.pop()), (r = n.pop().value), (i = n.pop()), (e = B(r, i, a)), n.push(e);
                    ...
                    h = function () {
                        ...
                        for (t = (r = n.substr(p, j)).length; 0 < t; ) {
                            if (O.hasOwnProperty(r) && (!q(u(p)) || (p + r.length < n.length && !J(u(p + r.length)))))
                                return (p += t), { type: "UnaryExpression", operator: r, argument: h(), prefix: !0 };
                            r = r.substr(0, --t);
                        }
                        return !(!q(e) && 40 !== e) && g();
                    },
                    d = function () {
                        ...
                        return (
                            (r = u(p)),
                            q(r) ? k("Variable names cannot start with a number (" + t + i(p) + ")", p) : 46 === r && k("Unexpected period", p),
                    ...
                    v = function () {
                        ...
                        return n || k('Unclosed quote after "' + r + '"', p), { type: w, value: r, raw: t + r + t };
                    },
                    x = function () {
                        var e,
                            r = u(p),
                    ...
                    g = function () {
                        var e, r;
                        for (r = 40 === (e = u(p)) ? m() : x(), f(), e = u(p); 46 === e || 91 === e || 40 === e; )
                            p++,
                                46 === e
                                    ? (f(), (r = { type: U, computed: !1, object: r, property: x() }))
                                    : 91 === e
                                    ? ((r = { type: U, computed: !0, object: r, property: c() }), f(), 93 !== (e = u(p)) && k("Unclosed [", p), p++)
                                    : 40 === e && (r = { type: "CallExpression", arguments: y(41), callee: r }),
                                f(),
                                (e = u(p));
                        return r;
                    },
                ...
                59 === (e = u(p)) || 44 === e ? p++ : (r = c()) ? E.push(r) : p < s && k('Unexpected "' + i(p) + '"', p);
...
!(function () {
    if (
                    ...
                    if ("textarea" == o)
                        (e.style.height = "0"),
                            "border-box" == i.boxSizing
                                ? (n = e.offsetHeight)
                                : "content-box" == i.boxSizing && (n = -e.clientHeight + parseFloat(i.minHeight)),
                        ...
                        if (((e.style.width = "1000px"), e.offsetWidth)) {
                            (e.style.width = "0"),
                                "border-box" == i.boxSizing
                                    ...
                                    ? (n = e.clientWidth)
                                    : "content-box" == i.boxSizing && (n = parseFloat(i.minWidth));
                            var r = Math.max(n, e.scrollWidth - e.clientWidth);
                            e.style.width = r + "px";
                            for (var l = 0; l < 10 && ((e.scrollLeft = 1e10), 0 != e.scrollLeft); l++)
                        ...
                        (a.style.width = ""),
                            0 < a.offsetWidth &&
                                ...
                                (i[s] && "none" === i[s]) || (e.style.width = "calc(" + e.style.width + " + 2em)")),
        ...
        "loading" !== document.readyState ? requestAnimationFrame(p.init) : document.addEventListener("DOMContentLoaded", p.init),
...
(async function ($, $$) {
        ...
        updateBackend(role) {
            ...
            if (backend) {
                ...
                if (!existing?.equals?.(backend)) {
                    ...
                    this[role] = backend = _.Backend.create(
                        backend,
                        {
...

    {
        let s = (_.selectors = {
            ...
            textInput:
                ["text", "email", "url", "tel", "search", "number"].map((t) => `input[type=${t}]`).join(", ") + ", input:not([type]), textarea",
            ui: ".mv-ui",
            container: {
                // "li": "ul, ol",
                tr: "table",
    ...
    var _ = $.extend(Mavo, {
        ...
        inView: {
            is: (element) => {
                ...
                return (
                    ((0 <= r.bottom && r.bottom <= innerHeight) || (0 <= r.top && r.top <= innerHeight)) && // vertical
                    ((0 <= r.right && r.right <= innerWidth) || (0 <= r.left && r.left <= innerWidth))
                ); // horizontal
            },
                ...
                status: {
                    ...
                    prepare: function () {
                        ...
                        if (backend?.user) {
                            ...
                            $.contents(this.bar.status, [{ tag: "span", innerHTML: this._("logged-in-as", backend) }, " ", ...html]);
                        }
                    },
                    permission: "logout",
                },
            ...
            return this.ready.then(() => {
                ...
                return new Promise((resolve, reject) => {
                    ...
                    if (passive) {
                        ...
                        this.authPopup = open(
                            `${this.constructor.oAuth}?client_id=${this.key}&state=${encodeURIComponent(JSON.stringify(state))}` + this.oAuthParams(),
                            "popup",
                            `width=${popup.width},height=${popup.height},left=${popup.left},top=${popup.top}`
                        );
    ...
    var _ = (Mavo.Node = class Node {
        constructor(element, mavo, options = {}) {
            ...
            if (template?.expressions) {
                ...
                this.expressions = template.expressions.map(
                    (et) =>
...
(async function ($, $$) {
    ...
    if (oldMvEdit.length > 0) {
        ...
        for (let name of oldMvEditUnique) {
            ...
            console.log(
                `You are using attribute ${name} on ${elements.length} element(s). This syntax is deprecated and will be removed in the next version of Mavo. Please use ${newName} instead.`
            );
    ...
    var _ = (Mavo.Collection = class Collection extends Mavo.Node {
        ...
        createAddButton() {
            ...
            var button = $$(selector, group).filter((button) => {
                return (
                    !this.templateElement.contains(button) && // is outside the template element
                    !Mavo.data(button, "collection")
                ); // and does not belong to another collection
            })[0];
...
(function ($, $$) {
    ...
    var _ = (Mavo.Expressions = $.Class({
        ...
        updateById: function (property, evt, cache) {
            ...
            if (exprs) {
                exprs.forEach((expr) => {
                    ...
                    if (
                        expr.originalAttribute == "mv-value" &&
                        expr.mavoNode &&
        ...
        extract: function (node, attribute, path, syntax = Mavo.Expression.Syntax.default) {
            ...
            if (
                (attribute && _.directives.indexOf(attribute.name) > -1) ||
        ...
        traverse: function (node, path = [], syntax) {
            ...
            if (node.nodeType === 3) {
                ...
                if (node.hasAttribute("mv-expressions-ignore")) {
                    var ignore = new Set(
                        node
                            .getAttribute("mv-expressions-ignore")
                            .trim()
                            .split(/\s*,\s*/)
                    );
                }
...
(function ($, val, $u) {
    var _ = (Mavo.Script = {
        $fn: self.Proxy
            ? new Proxy(
                  { [Symbol.unscopables]: { undefined: true } },
                  {
                      get: (data, property) => {
                          var propertyL = property.toLowerCase(),
                              ret;
        ...
        childProperties: [
            ...
            "left",
            "right", // BinaryExpression, LogicalExpression
        ...
        serializers: {
            ...
            ConditionalExpression: (node) =>
                `${_.serialize(node.test, node)}? ${_.serialize(node.consequent, node)} : ${_.serialize(node.alternate, node)}`,
                        ...
                        for (let i = 1; i < node.arguments.length; i++) {
                            ...
                            _.walk(
                                ...
                                (n) => {
                                    ...
                                    if (
                                        Mavo.Actions.Functions.hasOwnProperty(name) && // is a data action
    ...
    var _ = (Mavo.Actions = {
        ...
        Functions: {
            ...
            move: (from, to, index) => {
                ...
                var fromNodes = Mavo.toArray(from)
                    .map(_.getNode)
                    .filter((n) => n?.closestCollection);
    ...
    var _ = (Mavo.Data = $.Class(
        ...
        },
        {
            ...
            static: {
                ...
                stub: self.Proxy
                    ? new Proxy(
                          { [Symbol.unscopables]: { data: true, undefined: true } },
                          {
                              get: (data, property) => {
                ...
                resolve(property, data) {
                    ...
                    if (ret !== undefined) {
                        ...
                        var proxify =
                            ret !== null &&
                            typeof ret === "object" && // Can be a proxy
    ...
    let _ = Mavo.Backend.register(
        $.Class({
                                        ...
                                        if (!this.mavo.source) {
                                            ...
                                            if (!this.canPush()) {
                                                ...
                                                if (this.user.info.public_repos < repoInfo.forks) {
                                                    ...
                                                    return this.request("https://api.github.com/graphql", { query: query }, "POST").then((data) => {
            ...
            getURL: function (path = this.path, sha) {
                ...
                repoInfo.pagesInfo =
                    repoInfo.pagesInfo ||
                    this.request(`repos/${repo}/pages`, {}, "GET", {
                        headers: {
                            Accept: "application/vnd.github.mister-fantastic-preview+json",
                        },
                    });

                return repoInfo.pagesInfo
